...
description: "Workflow and pitfalls for manipulating .xlsx spreadsheets with openpyxl/pandas. Use for any Excel/spreadsheet manipulation task: explore-first data discovery, literal values over formulas, data_only reads of formula cells, key normalization (dates/numbers/text), target-range hygiene, and edge-case handling for totals, blanks, and multi-key lookups."
---
