Backup a list of songs from all of my Spotify playlists into a CSV file and email it to my husband. It should have headers "title" and "artists", and the artist names should be separated by "|".
