Make an order for two same-colored Gildan Men's Ultra Cotton T-Shirt in large size on Amazon. My color preference is, brown > navy blue > black. Pick the most preferred color that is available.
