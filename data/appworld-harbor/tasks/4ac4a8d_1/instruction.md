Denise, Glenn and I went on a trip recently. Yesterday, Denise emailed me their expenses in a pdf. Forward that thread to Glenn with an additional attachment of "~/documents/personal/expenses_james.pdf" from my file system, and a note prefixed to its body, "Can you please take care of splitting expenses? PFA for both of our expenses.".
