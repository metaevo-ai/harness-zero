I want to migrate my music library to Spotify. I have exported relevant information from my previous software to a text file which you can find in my file system in "~/backups". Create an account for me on Spotify, and add song library, album library, and playlists according to information in it.
