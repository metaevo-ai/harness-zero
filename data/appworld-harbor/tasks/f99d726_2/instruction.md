The last sweater I bought on Amazon is a bit too large for me. Initiate a return for it, and buy a replacement of the same in the next smaller size. If it's available now in red, prefer it, otherwise go with the same color.
