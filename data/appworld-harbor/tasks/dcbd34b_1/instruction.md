I have requested expense details from my coworkers via email for our recent company trip. Please extract relevant information from them and save it in "~/documents/work/reimbursements.csv". The file already has the headers. Fill in the rest.
