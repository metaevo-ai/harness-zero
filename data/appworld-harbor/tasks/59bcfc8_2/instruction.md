Buy a wall clock for Jennifer from Amazon in their favorite color (see phone voice message). Get it delivered to their home with gift wrapping. Given the choices, pick the highest rated one.
