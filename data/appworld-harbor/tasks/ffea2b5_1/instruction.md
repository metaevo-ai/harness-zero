Chad has asked me for my weekly workout plan over email. I have drafted a reply to it. Please export my workout plan note from Simple Note to a text file, attach it to the draft, and send the email.
