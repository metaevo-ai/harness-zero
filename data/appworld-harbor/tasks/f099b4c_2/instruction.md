I have jotted down my amazon shopping list in simple_note. Reset my amazon cart to have as many products in as many quantities from this list as available, and tell me its total cost. In calculating the total cost (i) only include the available items, and (ii) include tax, but not delivery fees as I will be using prime later.
