My work meeting files are available in the "~/documents/work/meetings/" directory in my file system. Currently, they are organized as "<date>__<file_name>.<extension>". Reorganize them in this format, "<file_name>/<date>.<extension>".
