Make an order for two same-colored Nordstrom Signature Cashmere Sweater in extra-small size on Amazon. My color preference is, yellow > orange > navy blue. Pick the most preferred color that is available.
