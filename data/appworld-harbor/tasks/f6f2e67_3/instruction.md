My brother has sent me a few childhood photos in a zip over email. Add all photos to it from "~/photographs/way_back/" from my file system and send a new email to both my parents with the subject "Old Pics", the body "PFA." and the updated zip attachment.
