For my job search, I've drafted emails to all potential employers in the last 4 days. Attach resume.pdf from my file system to each of them. If it's already attached, update it as I just made some changes to it. Then send the emails.
