Place an order for my home address as per my Amazon shopping list in SimpleNote. For each item in it, buy me the highest rated product available now. If two products have the same rating, pick the cheaper one.
