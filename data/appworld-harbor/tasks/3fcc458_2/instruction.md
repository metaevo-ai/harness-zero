Stephen has sent me a list of songs over email for our next roadtrip. Add songs to my Spotify playlist "Songs for Road Trip" that are not already there, and then make sure all the songs in it are downloaded for the trip.
