Nancy, Glen and I went on a trip recently. Yesterday, Nancy emailed me their expenses in a pdf. Forward that thread to Glen with an additional attachment of "~/documents/personal/bradley_trip_expenses.pdf" from my file system, and a note prefixed to its body, "Mind splitting expenses? Ours are attached.".
